...
let CreateAccountComponent = class CreateAccountComponent {
    constructor(fb, router, service, snackbar) {
        this.fb = fb;
        this.router = router;
        this.service = service;
        this.snackbar = snackbar;
...
let ForgotPasswordComponent = class ForgotPasswordComponent {
    constructor(authService, fb, snackbar, router) {
...
let LinkAccountComponent = class LinkAccountComponent {
    constructor(authService, fb, riotService, router, snackbar, service) {
        this.authService = authService;
        this.fb = fb;
...
let RecoveryPasswordComponent = class RecoveryPasswordComponent {
    constructor(authService, fb, snackbar, route, router) {
        this.authService = authService;
        this.fb = fb;
        this.snackbar = snackbar;
        this.route = route;
